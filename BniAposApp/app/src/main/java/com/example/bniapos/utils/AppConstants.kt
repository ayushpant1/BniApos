...
object AppConstants {
    ...
    const val DEFAULT_STAN = "0001"
    const val DEFAULT_INVOICE_NO = "0001"
    const val DEFAULT_TBID = "0001"
    const val DEFAULT_MMID = "1020000000002"
    const val DEFAULT_MTID = "1040000000001"
    const val DEFAULT_AGEN_COUNTER_CODE = "000001"
