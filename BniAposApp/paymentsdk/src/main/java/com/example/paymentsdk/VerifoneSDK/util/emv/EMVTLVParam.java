...
public class EMVTLVParam extends TagLengthValue {
    ...
    *  */
    ...
    public int flagAppendRemoveClear=1; //Append;
    ...
    public int append( String tlv ){
        int count = 0;
        byte[] bTLV = BytesUtil.hexString2ByteArray(tlv );
    ...
    public byte[] getTLV( int tag, byte[] value ) {
        ...
        System.arraycopy( BytesUtil.hexString2ByteArray(sTag), 0, TLV, 0, lenTag );
        offset = lenTag;
