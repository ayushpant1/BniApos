package com.example.paymentsdk.VerifoneSDK.util.transaction;


import com.example.paymentsdk.VerifoneSDK.util.data.DateUtil;
import com.example.paymentsdk.VerifoneSDK.util.data.StringUtil;
...
public class Session {
     ...
     */
    public final static String ACCOUNT_ENTRY_MODE_NON = "0";

    /**
     * 账号输入方式 - 手工
     * Account input method - Manual.
     */
    public final static String ACCOUNT_ENTRY_MODE_MANUAL = "1";

    /**
     * 账号输入方式 - 磁条卡
     * Account input method - Magcard.
     */
    public final static String ACCOUNT_ENTRY_MODE_MAGCARD = "90";// "2";

    /**
     * Account input method - Contact card.
     */
    public final static String ACCOUNT_SERVICE_ENTRY_MODE_CONTACT = "5";

    /**
     * 账号输入方式 - 快速 PBOC 借/贷记 CARD_TYPE_IC 卡读入（非接触式）
     * Account input method - Contactless card.
     */
    public final static String ACCOUNT_ENTRY_MODE_CONTACTLESS = "7";
