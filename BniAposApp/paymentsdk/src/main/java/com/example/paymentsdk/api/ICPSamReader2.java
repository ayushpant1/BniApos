...
public class ICPSamReader2 {

    /**
     * IC PSam reader object.
     */
    private UPSamReader pSamReader = CTIApplication.getDeviceService().getPSamReader2();
    ...
    private static class Creator {
        private static final ICPSamReader2 INSTANCE = new ICPSamReader2();
    }

    /**
     * Get IC PSam reader instance.
     */
    public static ICPSamReader2 getInstance() {
