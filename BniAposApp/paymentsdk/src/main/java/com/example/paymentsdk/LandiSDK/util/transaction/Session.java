package com.example.paymentsdk.LandiSDK.util.transaction;


import com.example.paymentsdk.LandiSDK.util.data.DateUtil;
import com.example.paymentsdk.LandiSDK.util.data.StringUtil;
...
public class Session {
     ...
     */
    public final static String ACCOUNT_ENTRY_MODE_MAGCARD = "2";
