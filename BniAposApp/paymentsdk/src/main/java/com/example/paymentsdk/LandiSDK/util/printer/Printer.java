package com.example.paymentsdk.LandiSDK.util.printer;
...
public class Printer {
     ...
     * Printer object.
     */
    private UPrinter printer = CTIApplication.getDeviceService().getPrinter();
    ...
    public Completable print() {
        return Completable.create(e -> printer.startPrint(new OnPrintListener.Stub() {
            @Override
