...
import com.example.paymentsdk.LandiSDK.api.DeviceManager;
import com.example.paymentsdk.LandiSDK.api.EMV;
import com.example.paymentsdk.LandiSDK.api.LED;
import com.example.paymentsdk.LandiSDK.api.PinpadForDUKPT;
import com.example.paymentsdk.LandiSDK.api.PinpadForMKSK;
import com.example.paymentsdk.LandiSDK.util.data.TLV;
import com.example.paymentsdk.LandiSDK.util.data.TLVList;
import com.example.paymentsdk.LandiSDK.util.emv.EmvData;
import com.example.paymentsdk.LandiSDK.util.emv.EmvParameterException;
import com.example.paymentsdk.LandiSDK.util.emv.EmvParameterInitializer;
import com.example.paymentsdk.LandiSDK.util.emv.EmvTags;
import com.example.paymentsdk.LandiSDK.util.pinpad.KeyId;
import com.example.paymentsdk.LandiSDK.util.transaction.Session;
...
import com.example.paymentsdk.sdk.Common.Util;
import com.example.paymentsdk.sdk.util.data.BytesUtil;
import com.example.paymentsdk.sdk.util.data.DateUtil;
import com.example.paymentsdk.sdk.util.data.StringUtil;
...
public class LandiTerminalCardApiHelper extends TerminalCardApiHelper {
    ...
    //Context _context,
    public LandiTerminalCardApiHelper(Context _context, ISuccessResponse_Card _successResponse) {
