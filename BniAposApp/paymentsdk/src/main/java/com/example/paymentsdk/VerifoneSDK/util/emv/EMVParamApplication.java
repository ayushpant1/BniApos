...
public class EMVParamApplication extends EMVTLVParam {
    ...
    public static int TAG__DF08_Optional = 0xDF08 ; //  Terminal Priority
    ...
    public static int TAG__DF18 = 0xDF18 ; //MIleage
    ...
    public static int TAG__87 = 0x87 ; //Application Priority Indicator
    public static int TAG__9C = 0x9C ; //Transaction Type
