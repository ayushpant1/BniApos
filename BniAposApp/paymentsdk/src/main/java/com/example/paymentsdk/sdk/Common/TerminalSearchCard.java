...
import com.example.paymentsdk.sdk.util.transaction.Session;
import com.usdk.apiservice.aidl.constants.RFDeviceName;
import com.usdk.apiservice.aidl.emv.SearchCardListener;

public class TerminalSearchCard implements AutoCloseable {
    ...
    //Context _context,
    public TerminalSearchCard(Context _context, ISuccessResponse_Card _successResponse) {
