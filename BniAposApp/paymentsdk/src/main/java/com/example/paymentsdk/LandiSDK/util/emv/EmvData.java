...
public class EmvData {
     ...
     */
    public static List<CAPublicKey> publicKeys =  LandiEmvData.getMockPublicKeys();
     ...
     */
    public static Map<String, Boolean> aids = LandiEmvData.getMockAids();

    /**
     * EMV basic parameters.
     */
    public static Map<String, BaseParameter> baseParameters = LandiEmvData.getMockBaseParameters();
     ...
     */
    public static Map<String, MasterParameter> masterParameters = LandiEmvData.getMockMasterParameters();
     ...
     * - value: PbocParameter
     */
    public static Map<String, PbocParameter> pbocParameters =  LandiEmvData.getMockPbocParameters();
     ...
     * - value: VisaParameter
     */
    public static Map<String, VisaParameter> visaParameters =LandiEmvData.getMockVisaParameters();
